...
path_group = pydiffvg.ShapeGroup(shape_ids = mx.array([0]),
                                 fill_color = mx.array([0.0, 0.0, 0.0, 0.0]),
...
pydiffvg.imwrite(img, 'results/single_stroke/target.png', gamma=2.2)
...
img = render(256, # width
             ...
             None, # background_image
             *scene_args)
pydiffvg.imwrite(img, 'results/single_stroke/init.png', gamma=2.2)
...
for t in range(200):
    ...
    pydiffvg.imwrite(img, 'results/single_stroke/iter_{}.png'.format(t), gamma=2.2)
...
pydiffvg.imwrite(img, 'results/single_stroke/final.png')
