...
pydiffvg.imwrite(img, 'results/single_curve/target.png', gamma=2.2)
...
img = render(256, # width
             ...
             None,
             *scene_args)
pydiffvg.imwrite(img, 'results/single_curve/init.png', gamma=2.2)
...
for t in range(100):
    ...
    pydiffvg.imwrite(img, 'results/single_curve/iter_{}.png'.format(t), gamma=2.2)
...
pydiffvg.imwrite(img, 'results/single_curve/final.png')
