...
pydiffvg.imwrite(img, 'results/single_path/target.png', gamma=2.2)
...
img = render(510, # width
             ...
             None, # background_image
             *scene_args)
pydiffvg.imwrite(img, 'results/single_path/init.png', gamma=2.2)
...
for t in range(100):
    ...
    pydiffvg.imwrite(img, 'results/single_path/iter_{:02}.png'.format(t), gamma=2.2)
...
pydiffvg.imwrite(img, 'results/single_path/final.png')
